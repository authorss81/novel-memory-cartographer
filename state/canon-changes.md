...
3. **Chapter 26 contradicted Chapter 27 on the Monday round** (five stops against Rue's announced seven) and put Rue on the Sunday's last run while Chapter 25 has her saying she would be. The forward-looking round sentence is cut from the Chapter 26 summary; Chapter 27 opens on the announcement properly.
...
10. **Two word-counts were wrong in a book whose method is counting.** Ilse Oller's note is **eleven words** and was called nine; *Second and Thursday* is **three words** and was called four. Both corrected. **Deliberately not corrected:** *not asked to* is three words and has been called four since Chapter 14, and that figure is canon in Chapters 14, 15, `bible/terminology.md` and `state/continuity.md`. Changing it here would mean editing Batch 0001 prose and breaking four state files for a figure a reader is unlikely to audit. **A later reviewer should not re-open it without a better argument.**
