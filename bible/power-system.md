...
**4. The Field Book, and this is the entry a later batch is most likely to get wrong.** **The dated pairs are ELEVEN: one six, four threes, one nine, one two, one five, ONE eight, one twenty-five and one thirty-six**, plus the single-day interval from the tenth of December that is looked at and is not written. **The thirty-six is the interval from the fourteenth of January to the nineteenth of February, the largest in the book, and the label says eleven and not ten. The four threes are not collapsed, and there is one eight — the *two eights* in any earlier note was the Batch 0002 error corrected at CR-032 item 9 and it must not come back.** He joins none of them to any other and has written down that he does not understand what eleven of a thing means. Atlas residue was used **once in ten chapters, in seven words: *Weather uses whatever door is open.***
